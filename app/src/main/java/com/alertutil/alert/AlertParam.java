...
//    Dialog class
     ...
     * The Dialog type.
     */
    private DialogType dialogType = DialogType.SINGLE_OPTION;
    /**
     * The Listener.
     */
    private OnDialogProcess listener;
    /**
     * The Icon.
     */
    private int icon = -1;
    ...
    public OnDialogProcess getListener() {
        return listener;
    }
...
/*Set Message for AlertDialog*/
        public DialogBuilder message(@NonNull String message) {
...
/*Set Drawable for AlertDialog*/
        public DialogBuilder icon(@NonNull Drawable drawable) {
...
/*Set PositiveButton Message for AlertDialog*/
        public DialogBuilder positiveButton(@NonNull String positiveButton) {
...
/*Set NegativeButton Message for AlertDialog*/
        public DialogBuilder negativeButton(@NonNull String negativeButton) {
...
/*Set NegativeButton Message resId for AlertDialog*/
        ...
        public DialogBuilder typeface(@NonNull String typeface) {
...
/*Set Listener for AlertDialog*/
        public DialogBuilder listener(@NonNull OnDialogProcess l) {
...
/*Set data bundle for AlertDialog*/
        public DialogBuilder bundle(@NonNull Bundle bundle) {
...
/* Set alertTask Id for Uniqueness */
        ...
        public AlertParam show() {
            ...
            if (mAlertParam.dialogType == AlertParam.DialogType.DOUBLE_OPTION ||
                ...
                if (mAlertParam.positiveButtonResId != -1) {
                    mAlert.setPositiveButton(mAlertParam.positiveButtonResId,
                            new DialogBuilder.OnDialogClick(mAlertParam, 1));
            ...
            if (mAlertParam.dialogType == AlertParam.DialogType.DOUBLE_OPTION) {
                if (mAlertParam.negativeButtonResId != -1) {
                    mAlert.setNegativeButton(mAlertParam.negativeButtonResId,
                            new DialogBuilder.OnDialogClick(mAlertParam, 2));
            ...
            if (mAlertParam.dialogType == AlertParam.DialogType.DIALOG_LIST) {
                mAlert.setItems(mAlertParam.list, new DialogBuilder.OnDialogClick(mAlertParam, 3));
            }
